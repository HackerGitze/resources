...
```{r}
set.seed(001) # setting a seed (in the best year ever??) - this way, even though it's random, you'll get reproducible results next time you run this with this seed

# rnorm() works like: my_simulated_data <- rnorm(n, mean, sd) - now you go!

# your code here

simulation <- rnorm(50, 6, 1)
...
mean(simulation)
sd(simulation)
#Otherwise it wouldn't be a simulation - you'd always get the same answer
```
...
#### (a) Forecasting/classification
 ...
 - Machine learning what a picture depicts

#### (b) Exploring associations

 - Which groceries people tend to buy together (e.g. milk & eggs or bread & butter)
...
#### (d) Causal inference
 ...
 - Whether ice cream has an effect on mood
...
### Ex. 2.7 (b) Reliability and validity: Give an example of a scenario of measurements that have reliability but not validity.
 ...
 - A tapemeasure of which has been cut 2 cm off
